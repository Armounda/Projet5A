...
#ifndef AI_SINUS_NETWORK_H
#define AI_SINUS_NETWORK_H
#pragma once

#include "sinus_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SINUS_NETWORK_MODEL_NAME          "sinus_network"
#define AI_SINUS_NETWORK_ORIGIN_MODEL_NAME   "hello_world_int8"

/******************************************************************************/
#define AI_SINUS_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SINUS_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SINUS_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SINUS_NETWORK_IN_NUM        (1)
...
#define AI_SINUS_NETWORK_IN_SIZE_BYTES { \
  AI_SINUS_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_SINUS_NETWORK_IN_1_FORMAT      AI_BUFFER_FORMAT_S8
#define AI_SINUS_NETWORK_IN_1_CHANNEL     (1)
#define AI_SINUS_NETWORK_IN_1_SIZE        (1)
#define AI_SINUS_NETWORK_IN_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_SINUS_NETWORK_OUT_NUM       (1)
...
#define AI_SINUS_NETWORK_OUT_SIZE_BYTES { \
  AI_SINUS_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_SINUS_NETWORK_OUT_1_FORMAT      AI_BUFFER_FORMAT_S8
#define AI_SINUS_NETWORK_OUT_1_CHANNEL     (1)
#define AI_SINUS_NETWORK_OUT_1_SIZE        (1)
#define AI_SINUS_NETWORK_OUT_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_SINUS_NETWORK_N_NODES (3)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup sinus_network
 ...
 * @ref ai_sinus_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_sinus_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sinus_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sinus_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SINUS_NETWORK_*
 * defines into file @ref sinus_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sinus_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SINUS_NETWORK_H */
